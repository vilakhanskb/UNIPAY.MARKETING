  ...
  const details = {
    unipos: {
      ...
      capabilityGroups: [
        ...
        { title: 'ນະໂຍບາຍ, ຂໍ້ມູນ ແລະລາຍງານ', items: ['ຫຼັກຖານນະໂຍບາຍ ແລະ ລິ້ງສັ້ນ', 'ຊຸດຂໍ້ມູນ ແລະ ການສົ່ງອອກ', 'ສູນລາຍງານ'] }
      ],
    ...
    wallet: {
      ...
      capabilityGroups: [{ title: 'ລູກຄ້າ ແລະ KYC', items: ['ພາບລວມ', 'ການກວດສອບ KYC', 'ການກວດສອບລູກຄ້າ'] }, { title: 'ທຸລະກຳ ແລະການຕັ້ງຄ່າ', items: ['ທຸລະກຳ', 'ການຕັ້ງຄ່າຜູ້ແນະນຳ', 'ລາຍການໂອນລ່າສຸດ'] }, { title: 'ລາຍງານ ແລະ Audit Log', items: ['ຍອດ Wallet', 'ສະຫຼຸບລາຍຈ່າຍ', 'ສະຫຼຸບລາຍຮັບ', 'ປະຫວັດກວດສອບ Wallet'] }],
