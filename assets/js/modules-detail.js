    ...
    unipos: {
      ...
      roleWorkflows: [
        ...
        },
        {
          code: 'ADMIN',
          label: 'ຜູ້ຈັດການສາຂາ',
          pitch: 'ບໍລິຫານງານປະຈຳວັນໃນຂອບເຂດສາຂາທີ່ Owner ມອບໝາຍໃຫ້.',
          scope: 'ຕິດຕາມການຂາຍ, ການເປີດ-ປິດກະ, ສິນຄ້າ/ສະຕ໋ອກ ແລະຜົນງານຂອງສາຂາຕາມສິດທີ່ໄດ້ຮັບ.',
          steps: ['ເຂົ້າສາຂາທີ່ໄດ້ຮັບມອບໝາຍ', 'ກວດກະ ແລະການຂາຍປະຈຳວັນ', 'ຕິດຕາມສິນຄ້າ/ສະຕ໋ອກ', 'ສົ່ງຕໍ່ຂໍ້ມູນໃຫ້ Owner ຕັດສິນໃຈ']
        },
        {
          code: 'CASHIER',
          label: 'ພະນັກງານຂາຍ',
